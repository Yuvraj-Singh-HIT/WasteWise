...
- ♻️ Only **17.4%** of e-waste is properly recycled
...
# 5️⃣ (Optional) Start AI development server
npm run genkit:dev
```
...
- [ ] 🗺️ Integration with local recycling centers
